...
export default function ProjectTable( {handleClose} ) {
    ...
    /**
 * @function createProjectFunc - This function creates a new project with using createProject function in ProjectService
